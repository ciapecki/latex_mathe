...
%              \draw[line width=2pt,color=ccqqqq,smooth,samples=100,domain=-2.3019060283688253:2.9719414893617393] plot(\x,{(\x)^(4)-(\x)^(3)-1/2*(\x)^(2)+(\x)});
              ...
              \clip(-3.9183806146572397,-3.177277763111059) rectangle (3.1526595744681156,3.299672591498936);
    ...
    \subfloat[Bild 2]{
          ...
          \draw[line width=1pt,color=ccqqqq,smooth,samples=100,domain=-2.301906028368825:2.9719414893617384] plot(\x,{-1/10*(\x)^(5)+3/8*(\x)^(4)+(\x)});
          \begin{scriptsize}
    ...
    \subfloat[Bild 3]{
        ...
        \draw[line width=1pt,color=ccqqqq,smooth,samples=100,domain=-2.6600620567376185:2.488430851063855] plot(\x,{-0.5*(\x)^(4)+1.5*(\x)^3});
        \begin{scriptsize}
