...
\begin{tikzpicture}[>=latex, x=2cm, y=2cm, line cap=round, line join=round, scale=1.5]
  \begin{axis}[
    ...
    \addplot[line width=1pt,color=ccqqqq,smooth,samples=100, domain=-2.5:2.7]plot(\x,{0-(9/40)*((\x)+2)*((\x)-1)^(2)*((\x)-2)});
    \draw[color=ccqqqq] (-2.2,-1.3) node[anchor=north west] {$f$};
...
\begin{tikzpicture}[>=latex, x=2cm, y=2cm, line cap=round, line join=round, scale=1.2]
\begin{axis}[
  unit vector ratio=1 1,
  axis x line=center,
  axis y line=center,
...
%    \draw[line width=2pt,color=qqwuqq,smooth,samples=100,domain=-21.518627341217258:25.46534828151831] plot(\x,{5*((\x)^(2)/3-(\x)^(3)/20)});
  ...
  \addplot[line width=1pt,color=ccqqqq,smooth,samples=100, domain=-5:10]plot(\x,{((\x)^(3)-6*(\x)^(2)+8*(\x))});
