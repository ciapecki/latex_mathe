...
\Aufgabe{1:}
    Gegeben ist die Funktion $f: f(x)=1,5-2,5x-x^2;$ $D= \mathbb{R}$
...
\item Bestimmen Sie  $f'(x)$ im Punkt $x_0=-2$ mit h-Methode. 
\item Bestimmen Sie die Tangenten- und Normalengleichung der Funktion $f$ im Punkt $P(-2|f(-2))$
\end{enumerate}

\begin{flushright}14BE \end{flushright}
