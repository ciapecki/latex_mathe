...
\Aufgabe{1:}
   Bestimmen Sie in der Teilaufgaben a), b) und c) jeweils die Ableitungsfunktion:
...
\item $h(x)=\frac {\frac{1}{3}x^4 - 3x^2}{x^2+2}$
  \vspace{7cm}
\item Geben Sie die Gleichung einer möglichen Stammfunktion $F$ von $f$ an.
  \vspace{3cm}
 \item Vereinfachen Sie den Nenner und den Zähler der Funktion $h'(x)$ soweit wie möglich.
\end{enumerate}

\begin{flushright}11BE \end{flushright}
