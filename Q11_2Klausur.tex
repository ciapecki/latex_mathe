...
\includegraphics[width=\linewidth]{Q11_2Klausur_MusterLsg2.png}

\newpage
\Aufgabe{3: Musterlösung}
\includegraphics[width=0.6\linewidth]{Q11_2Klausur_MusterLsg3-0.png}
\\
\includegraphics[width=0.6\linewidth]{Q11_2Klausur_MusterLsg3-1.png}
...
\begin{minipage}[t]{0.27\textwidth}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.4\columnwidth]{Q11_2Klausur_3_fisch.png}
    %\caption{A boat.}
    %\label{fig:boat1}
  \end{figure}
\end{minipage}
...
\newpage
\Aufgabe{3: Musterlösung}
\includegraphics[width=1\linewidth]{Q11_2Klausur_MusterLsg3n_DeepBlue.png}
