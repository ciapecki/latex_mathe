...
\Aufgabe{2:}
Vorgelelgt ist die Ebene E: 
\[
          E: \vec{X} = \begin{pmatrix}4 \\ -5 \\-6 \end{pmatrix} 
                     + \lambda \begin{pmatrix}1 \\ 2 \\2 \end{pmatrix}
            \quad
        

und die Gerade  g: \vec{X} = \begin{pmatrix}1 \\ 0 \\3 \end{pmatrix}
                     + \lambda \begin{pmatrix}r \\ s \\-6 \end{pmatrix}   (\lambda; \r \s \mathbb{R})
\]
Wie sind die Parameter$ r, s $ und $ t$ zu wählen, damit die Gerade $g$
\begin{enumerate}[label={\alph*)}]
\item senkrecht zur Ebene $E$ verläuft?
\itemecht parallel zur Ebene $E$ verläuft?
\itemecht in der Ebene  $E$ liegt? 
\end{enumerate}

\begin{flushright}5BE \end{flushrig}
